...
export default function FolderSection({ title, children, index, tab, color }: Props) {
  ...
  return (
      ...
      >
        ...
        <div
            ...
            className="
          h-[5vh] w-[16.666667vw] rounded-t-[12px]
        ...
        >
          ...
          <span className="font-mono text-[11px] text-white/50 tracking-[0.2em] uppercase">
            {paddedIndex}
          </span>
          <span className="font-mono text-xs text-white/80 tracking-[0.3em] uppercase truncate mx-2">
            {title}
          </span>
          <span className="font-mono text-[11px] text-white/40 tracking-[0.2em]">
            T-0
          </span>
        </span>
        </div>
        ...
        {/* BODY */}
        <div className="h-screen border-2 border-foreground overflow-hidden flex flex-col bg-background rounded-tr-[12px]">
          ...
          font-mono text-[9px] md:text-[10px] text-white/35
