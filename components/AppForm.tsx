...
export default function AppForm() {
  ...
  const inputClass = `
    ...
    outline-none
    font-mono text-[11px] md:text-sm text-foreground/80 tracking-[0.2em] uppercase
      ...
      <div className="flex-1 flex items-center justify-center px-4 md:px-12 py-6 md:py-8">
        <div className="w-full max-w-xs md:max-w-2xl">
          ...
          <div className="mb-6 md:mb-10">
            <p className="font-mono text-[10px] md:text-[11px] text-foreground/40 tracking-[0.4em] uppercase mb-2 md:mb-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-5">
            ...
            <div className="flex items-center gap-4 md:gap-6 pt-1 md:pt-2">
              <button
                ...
                text-[10px] md:text-xs uppercase tracking-[0.4em] md:tracking-[0.5em] text-foreground/80
                transition-all duration-300 hover:border-foreground hover:bg-foreground/5 hover:text-white
              ...
              {status === "success" && (
                  <p className="font-mono text-[10px] md:text-[11px] tracking-[0.3em] uppercase text-foreground/60">
                    ✓ Received
                  </p>
              )}
              {status === "error" && (
                  <p className="font-mono text-[10px] md:text-[11px] tracking-[0.3em] uppercase text-red-400/80">
                    ✗ {errorMsg}
                  </p>
              )}
            </div>
          ...
          <div className="mt-6 md:mt-10 pt-3 md:pt-4 border-t border-foreground/20 font-mono text-[9px] md:text-[10px] text-foreground/35 tracking-[0.3em] uppercase">
